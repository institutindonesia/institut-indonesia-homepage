var plugins = [{
      ...
      plugin: require('/home/coding/next-netlify-starter/node_modules/gatsby-plugin-sitemap/gatsby-ssr'),
      options: {"plugins":[],"output":"/sitemap","createLinkInHead":true,"entryLimit":45000,"query":"{ site { siteMetadata { siteUrl } } allSitePage { nodes { path } } }","excludes":[]},
    },{
      name: 'gatsby-plugin-image',
      plugin: require('/home/coding/next-netlify-starter/node_modules/gatsby-plugin-image/gatsby-ssr'),
      options: {"plugins":[]},
    },{
      name: 'gatsby-plugin-react-helmet',
      plugin: require('/home/coding/next-netlify-starter/node_modules/gatsby-plugin-react-helmet/gatsby-ssr'),
      options: {"plugins":[]},
    },{
      name: 'gatsby-plugin-offline',
      plugin: require('/home/coding/next-netlify-starter/node_modules/gatsby-plugin-offline/gatsby-ssr'),
      options: {"plugins":[],"workboxConfig":{"globPatterns":["**/*"]}},
    },{
      name: 'gatsby-plugin-dark-mode',
      plugin: require('/home/coding/next-netlify-starter/node_modules/gatsby-plugin-dark-mode/gatsby-ssr'),
      options: {"plugins":[]},
    },{
      name: '@wardpeet/gatsby-image-nextgen',
      plugin: require('/home/coding/next-netlify-starter/node_modules/@wardpeet/gatsby-image-nextgen/gatsby-ssr'),
      options: {"plugins":[]},
    }]
/* global plugins */
